...
%% ocamlweb -p \usepackage{url} \usepackage{graphicx} --noweb intro.tex ../ML/pidgin.ml gen.tex ../ML/gen.ml list2.tex ../ML/list2.ml word.tex ../ML/word.ml zipper.tex ../ML/zipper.ml bintree.tex ../ML/bintree.ml trie.tex ../ML/trie.ml ascii.tex ../ML/ascii.ml lexicon.tex ../ML/lexicon.ml make_lex.tex ../ML/make_lex.ml share.tex ../ML/share.mli ../ML/share.ml mini.tex ../ML/mini.ml dagify.tex ../ML/dagify.ml ../ML/make_english_lexicon.ml english.tex ../ML/zen_lexer.ml ../ML/transducer.ml ../ML/latin.ml french.tex ../ML/make_french_lexicon.ml sanskrit.tex tertree.tex ../ML/tertree.ml ../ML/minitertree.ml deco.tex ../ML/deco.ml lexmap.tex ../ML/lexmap.ml minimap.tex ../ML/minimap.mli ../ML/minimap.ml unglue.tex ../ML/unglue.ml ../ML/unglue_test.ml coroutines.tex intro_aum0.tex ../ML/aum0.mli react0.tex ../ML/react0.ml aumt.tex ../ML/aumt.mli reactt.tex ../ML/reactt.ml regular.tex ../ML/regular.ml linking.tex ../ML/sanskrit_engine.ml conclusion.tex biblio.tex -o zen.tex 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
{\Large Version 5.1 - November 25th, 2018}\\[15pt]
{\large G\'erard Huet \& Beno{\^\i}t Razet}\\[10pt]
{\large Copyright \copyright ~2002-2018 INRIA}\\[20pt]
\end{center}
...
;\ocweol
\ocwindent{0.00em}
$\ocwlowerid{value}~\ocwlowerid{opt\_app}~\ocwlowerid{f}~=~$\ocwkw{fun}~$[~\ocwupperid{None}~\rightarrow{}~\ocwupperid{None}~\mid{}~\ocwupperid{Some}~\ocwlowerid{x}~\rightarrow{}~\ocwupperid{Some}~(\ocwlowerid{f}~\ocwlowerid{x})~]$\ocweol
\ocwindent{0.00em}
;\medskip
...
\ocwendcode{}\ocwindent{0.00em}
\ocwbegindcode{}$\ocwlowerid{split}~\ocwlowerid{n}~\ocwlowerid{l}$\ocwenddcode{} returns a pair of lists \ocwbegindcode{}$(\ocwlowerid{prefix},~\ocwlowerid{suffix})$\ocwenddcode{} such that
   \ocwbegindcode{}$\ocwlowerid{prefix}~@~\ocwlowerid{suffix}~=~\ocwlowerid{l}$\ocwenddcode{} and \ocwbegindcode{}$\ocwupperid{List}.\ocwlowerid{length}~\ocwlowerid{prefix}~=~\ocwlowerid{n}$\ocwenddcode{}.  
   Raises \ocwbegindcode{}$\ocwupperid{Failure}~$\ocwstring{"split"}\ocwenddcode{} if \ocwbegindcode{}$\ocwlowerid{n}~<~0$\ocwenddcode{} or \ocwbegindcode{}$\ocwlowerid{n}~>~\ocwupperid{List}.\ocwlowerid{length}~\ocwlowerid{l}$\ocwenddcode{}.  
\ocweol
\label{../ML/list2.ml:2746}%
\medskip
\ocwbegincode{}\ocwindent{0.00em}
$\ocwlowerid{value}~\ocwlowerid{split}~\ocwlowerid{n}~\ocwlowerid{l}~=~\ocwlowerid{aux}~\ocwlowerid{n}~\ocwlowerid{l}~[\,]$\ocweol
\ocwindent{1.00em}
$\ocwlowerid{where}~$\ocwkw{rec}~$\ocwlowerid{aux}~\ocwlowerid{n}~\ocwlowerid{l}~\ocwlowerid{acc}~=$\ocweol
\ocwindent{1.00em}
\ocwkw{if}~$\ocwlowerid{n}~=~0~$\ocwkw{then}~$(\ocwupperid{List.}\ocwlowerid{rev}~\ocwlowerid{acc},~\ocwlowerid{l})~$\ocwkw{else}\ocweol
\ocwindent{2.00em}
\ocwkw{match}~$\ocwlowerid{l}~$\ocwkw{with}\ocweol
\ocwindent{2.00em}
$[~[\,]~\rightarrow{}~\ocwlowerid{failwith}~$\ocwstring{"split"}\ocweol
\ocwindent{2.00em}
$\mid{}~[~\ocwlowerid{h}~::~\ocwlowerid{t}~]~\rightarrow{}~\ocwlowerid{aux}~(\ocwlowerid{n}~-~1)~\ocwlowerid{t}~[~\ocwlowerid{h}~::~\ocwlowerid{acc}~]$\ocweol
\ocwindent{2.00em}
$]$\ocweol
\ocwindent{0.00em}
;\ocweol
\ocwindent{0.00em}
\ocwbc{} \ocwbegindcode{}$\ocwlowerid{truncate}~\ocwlowerid{n}~\ocwlowerid{l}$\ocwenddcode{} removes from \ocwbegindcode{}$\ocwlowerid{l}$\ocwenddcode{} its initial sublist of length \ocwbegindcode{}$\ocwlowerid{n}$\ocwenddcode{}. \ocwec{}\ocweol
\ocwindent{0.00em}
\ocwbc{} \ocwbegindcode{}$\ocwlowerid{truncate}~:~$\ocwbt{int}~$\rightarrow{}~$\ocwbt{list}~$\alpha{}~\rightarrow{}~$\ocwbt{list}~$\alpha{}$\ocwenddcode{}                             \ocwec{}\ocweol
\ocwindent{0.00em}
$\ocwlowerid{value}~\ocwlowerid{truncate}~\ocwlowerid{n}~\ocwlowerid{l}~=$\ocweol
\ocwindent{1.00em}
\ocwkw{try}~$\ocwlowerid{snd}~(\ocwlowerid{split}~\ocwlowerid{n}~\ocwlowerid{l})~$\ocwkw{with}~$[~\ocwupperid{Failure}~\ocwlowerid{\_}~\rightarrow{}~\ocwlowerid{failwith}~$\ocwstring{"truncate"}~$]$\ocweol
\ocwindent{0.00em}
;\ocweol
\ocwindent{0.00em}
\ocwbc{} \ocwbegindcode{}$\ocwlowerid{take\_prefix}~\ocwlowerid{n}~\ocwlowerid{l}$\ocwenddcode{} returns the first \ocwbegindcode{}$\ocwlowerid{n}$\ocwenddcode{} elements of \ocwbegindcode{}$\ocwlowerid{l}$\ocwenddcode{} (in the same
   order of occurrence as in \ocwbegindcode{}$\ocwlowerid{l}$\ocwenddcode{}).  If \ocwbegindcode{}$\ocwlowerid{n}~>~\ocwupperid{List}.\ocwlowerid{length}~\ocwlowerid{l}$\ocwenddcode{}, then it returns
   the whole list \ocwbegindcode{}$\ocwlowerid{l}$\ocwenddcode{}.  
   Raises \ocwbegindcode{}$\ocwupperid{Failure}~$\ocwstring{"take\_prefix"}\ocwenddcode{} if \ocwbegindcode{}$\ocwlowerid{n}~<~0$\ocwenddcode{} or \ocwbegindcode{}$\ocwlowerid{n}~>~\ocwupperid{List}.\ocwlowerid{length}~\ocwlowerid{l}$\ocwenddcode{}.  \ocwec{}\ocweol
\ocwindent{0.00em}
$\ocwlowerid{value}~\ocwlowerid{take\_prefix}~\ocwlowerid{n}~\ocwlowerid{l}~=$\ocweol
\ocwindent{1.00em}
\ocwkw{try}~$\ocwlowerid{fst}~(\ocwlowerid{split}~\ocwlowerid{n}~\ocwlowerid{l})~$\ocwkw{with}~$[~\ocwupperid{Failure}~\ocwlowerid{\_}~\rightarrow{}~\ocwlowerid{failwith}~$\ocwstring{"take\_prefix"}~$]$\ocweol
\ocwindent{0.00em}
;\ocweol
\ocwindent{0.00em}
...
\ocweol
\label{../ML/list2.ml:4525}%
\medskip
\ocwbegincode{}\ocwindent{0.00em}
$\ocwlowerid{value}~\ocwlowerid{implode}~\ocwlowerid{chars}~=~$\ocweol
\ocwindent{1.00em}
\ocwkw{let}~$\ocwlowerid{buf}~=~\ocwupperid{Buffer.}\ocwlowerid{create}~16~$\ocwkw{in}~\ocwkw{do}\ocweol
\ocwindent{1.00em}
\{~$\ocwupperid{List.}\ocwlowerid{iter}~(\ocwupperid{Buffer.}\ocwlowerid{add\_char}~\ocwlowerid{buf})~\ocwlowerid{chars}$\ocweol
\ocwindent{1.00em}
;~$\ocwupperid{Buffer.}\ocwlowerid{contents}~\ocwlowerid{buf}$\ocweol
\ocwindent{1.00em}
\}\ocweol
\ocwindent{0.00em}
;\medskip
...
\ocwmodule{Bintree}
\label{../ML/bintree.ml:0}%
\label{../ML/bintree.ml:684}%
\ocwbegincode{}\ocwindent{0.00em}
...
\ocwinterface{Share}
\label{../ML/share.mli:0}%
\label{../ML/share.mli:618}%
\ocwbegincode{}\ocwindent{0.00em}
...
\label{../ML/make_english_lexicon.ml:0}%
English words, using ASCII encoding 
\ocweol
\label{../ML/make_english_lexicon.ml:757}%
\medskip
\ocwbegincode{}\ocwindent{0.00em}
...
\ocwindent{2.00em}
$[~[~\ocwupperid{LETTER}~$\ocwstring{"a"};~\ocwstring{"\^{}"}~$\rightarrow{}~$\ocwstring{"â"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"a"};~\ocwstring{"`"}~$\rightarrow{}~$\ocwstring{"à"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"a"}~$\rightarrow{}~$\ocwstring{"a"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"e"};~\ocwstring{"'"}~$\rightarrow{}~$\ocwstring{"é"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"e"};~\ocwstring{"`"}~$\rightarrow{}~$\ocwstring{"è"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"e"};~\ocwstring{"\^{}"}~$\rightarrow{}~$\ocwstring{"ê"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"e"};~\ocwstring{"\symbol{92}""}~$\rightarrow{}~$\ocwstring{"ë"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"e"}~$\rightarrow{}~$\ocwstring{"e"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"i"};~\ocwstring{"\^{}"}~$\rightarrow{}~$\ocwstring{"î"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"i"};~\ocwstring{"\symbol{92}""}~$\rightarrow{}~$\ocwstring{"ï"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"i"}~$\rightarrow{}~$\ocwstring{"i"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"o"};~\ocwstring{"\^{}"}~$\rightarrow{}~$\ocwstring{"ô"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"o"}~$\rightarrow{}~$\ocwstring{"o"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"u"};~\ocwstring{"`"}~$\rightarrow{}~$\ocwstring{"ù"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"u"};~\ocwstring{"\^{}"}~$\rightarrow{}~$\ocwstring{"û"}\ocweol
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"u"};~\ocwstring{"\symbol{92}""}~$\rightarrow{}~$\ocwstring{"ü"}\ocweol
\ocwindent{3.00em}
...
\ocwindent{3.00em}
$\mid{}~\ocwupperid{LETTER}~$\ocwstring{"c"};~\ocwstring{"/"}~$\rightarrow{}~$\ocwstring{"ç"}\ocweol
\ocwindent{3.00em}
...
\label{../ML/make_french_lexicon.ml:0}%
French words, using Latin encoding. 
\ocweol
\label{../ML/make_french_lexicon.ml:784}%
\medskip
\ocwbegincode{}\ocwindent{0.00em}
...
called lexical maps. 
\ocweol
\label{../ML/lexmap.ml:924}%
\medskip
\ocwbegincode{}\ocwindent{0.00em}
\ocwkw{open}~$\ocwupperid{Deco};$\medskip

\label{../ML/lexmap.ml:936}%
\ocwindent{0.00em}
...
\label{../ML/minimap.mli:0}%
Minimization of Lexical Maps. 
\ocweol
\label{../ML/minimap.mli:654}%
\medskip
\ocwbegincode{}\ocwindent{0.00em}
...
\ocwmodule{Minimap}
\label{../ML/minimap.ml:0}%
\label{../ML/minimap.ml:655}%
\ocwbegincode{}\ocwindent{0.00em}
...
\ocweol
\label{../ML/aumt.mli:695}%
\medskip
\ocwbegincode{}\ocwindent{0.00em}
\ocwkw{module}~$\ocwupperid{Auto}~:~$\ocwkw{sig}\medskip

\label{../ML/aumt.mli:714}%
\ocwindent{0.00em}
...
\label{../ML/sanskrit_engine.ml:776}%
\ocwindent{0.00em}
...
\label{../ML/sanskrit_engine.ml:859}%
\ocwindent{0.00em}
...
\label{../ML/sanskrit_engine.ml:928}%
\ocwindent{1.00em}
...
\ocwbeginindex{}
\ocwrefindexentry{$\ocwupperid{Ascii}$ (module)}{../ML/ascii.ml:0}{../ML/lexicon.ml:814,../ML/lexicon.ml:951}{\ref{../ML/ascii.ml:0}}{\ref{../ML/lexicon.ml:814}, \ref{../ML/lexicon.ml:951}}
\ocwrefindexentry{$\ocwupperid{Aum0}$ (module)}{../ML/aum0.mli:0}{}{\ref{../ML/aum0.mli:0}}{}
\ocwrefindexentry{$\ocwupperid{Aumt}$ (module)}{../ML/aumt.mli:0}{}{\ref{../ML/aumt.mli:0}}{}
\ocwrefindexentry{$\ocwupperid{Bintree}$ (module)}{../ML/bintree.ml:0}{}{\ref{../ML/bintree.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Dagify}$ (module)}{../ML/dagify.ml:0}{}{\ref{../ML/dagify.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Deco}$ (module)}{../ML/deco.ml:0}{}{\ref{../ML/deco.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Gen}$ (module)}{../ML/gen.ml:0}{}{\ref{../ML/gen.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Latin}$ (module)}{../ML/latin.ml:0}{}{\ref{../ML/latin.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Lexicon}$ (module)}{../ML/lexicon.ml:0}{}{\ref{../ML/lexicon.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Lexmap}$ (module)}{../ML/lexmap.ml:0}{}{\ref{../ML/lexmap.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{List2}$ (module)}{../ML/list2.ml:0}{}{\ref{../ML/list2.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Make\_english\_lexicon}$ (module)}{../ML/make_english_lexicon.ml:0}{}{\ref{../ML/make_english_lexicon.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Make\_french\_lexicon}$ (module)}{../ML/make_french_lexicon.ml:0}{}{\ref{../ML/make_french_lexicon.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Make\_lex}$ (module)}{../ML/make_lex.ml:0}{}{\ref{../ML/make_lex.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Mini}$ (module)}{../ML/mini.ml:0}{}{\ref{../ML/mini.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Minimap}$ (module)}{../ML/minimap.mli:0,../ML/minimap.ml:0}{}{\ref{../ML/minimap.mli:0}, \ref{../ML/minimap.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Minitertree}$ (module)}{../ML/minitertree.ml:0}{}{\ref{../ML/minitertree.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Pidgin}$ (module)}{../ML/pidgin.ml:0}{}{\ref{../ML/pidgin.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{React0}$ (module)}{../ML/react0.ml:0}{}{\ref{../ML/react0.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Reactt}$ (module)}{../ML/reactt.ml:0}{}{\ref{../ML/reactt.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Regular}$ (module)}{../ML/regular.ml:0}{}{\ref{../ML/regular.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Sanskrit\_engine}$ (module)}{../ML/sanskrit_engine.ml:0}{}{\ref{../ML/sanskrit_engine.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Share}$ (module)}{../ML/share.mli:0,../ML/share.ml:0}{}{\ref{../ML/share.mli:0}, \ref{../ML/share.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Tertree}$ (module)}{../ML/tertree.ml:0}{}{\ref{../ML/tertree.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Transducer}$ (module)}{../ML/transducer.ml:0}{}{\ref{../ML/transducer.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Trie}$ (module)}{../ML/trie.ml:0}{../ML/lexicon.ml:814,../ML/lexicon.ml:951}{\ref{../ML/trie.ml:0}}{\ref{../ML/lexicon.ml:814}, \ref{../ML/lexicon.ml:951}}
\ocwrefindexentry{$\ocwupperid{Unglue}$ (module)}{../ML/unglue.ml:0}{}{\ref{../ML/unglue.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Unglue\_test}$ (module)}{../ML/unglue_test.ml:0}{}{\ref{../ML/unglue_test.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Word}$ (module)}{../ML/word.ml:0}{}{\ref{../ML/word.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Zen\_lexer}$ (module)}{../ML/zen_lexer.ml:0}{}{\ref{../ML/zen_lexer.ml:0}}{}
\ocwrefindexentry{$\ocwupperid{Zipper}$ (module)}{../ML/zipper.ml:0}{}{\ref{../ML/zipper.ml:0}}{}
